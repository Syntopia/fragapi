...
Camera2D.prototype = {
	...
	doZoom: function(factor) {
		dx = this.mouseX-this.getViewWidth()/2;
		dy = this.getViewHeight()/2-this.mouseY;
...
FrameBuffer.prototype = {
    ...
    initShaders: function() {
        ...
        if (this.vertexShaderSource == null && fragapi.pendingOperations.length == 0) {
            this.vertexShaderSource = this.resolve(this.vertexShader);
        }
		
		if (this.fragmentShaderSource == null && fragapi.pendingOperations.length == 0) {
